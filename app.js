...
const I18N = {
  it: {
    ...
    "hero.eyebrow": "Tenero · Ticino · dal 1990",
    "hero.title": "Usiamo l'acqua per dare vita ai <span class=\"accent\">vostri sogni</span>",
    "hero.lead": "Laghetti koi, biolaghi e biopiscine realizzati su misura. Oltre trent'anni di passione, dal primo laghetto fai-da-te a un giardino acquatico che diventa il cuore della vostra casa.",
    "hero.cta1": "Guarda le realizzazioni", "hero.cta2": "Richiedi un sopralluogo",
    "hero.stat1": "anni di esperienza", "hero.stat2": "laghetti realizzati", "hero.stat3": "su misura",
    "serv.kicker": "Cosa facciamo", "serv.title": "Soluzioni d'acqua, su misura per voi",
    ...
    "serv.koi.t": "Laghetti Koi", "serv.koi.d": "Lagune per carpe koi con filtraggio professionale e profondità ideale per esemplari sani e longevi.",
    ...
    "about.p1": "Tutto è cominciato all'inizio degli anni '90, dal primo laghetto fai-da-te realizzato nel giardino di casa. Da lì, anno dopo anno, la passione per l'acqua e per le carpe koi è diventata un mestiere.",
    ...
    "proj.g1t": "Laguna Koi", "proj.g1s": "Filtraggio professionale",
    ...
    "proj.note": "Immagini dimostrative. Nel sito finale verranno sostituite con le fotografie reali dei vostri lavori.",
  ...
  de: {
    ...
    "hero.eyebrow": "Tenero · Tessin · seit 1990",
    "hero.title": "Mit Wasser erwecken wir <span class=\"accent\">Ihre Träume</span> zum Leben",
    "hero.lead": "Koiteiche, Bioteiche und Schwimmteiche – massgeschneidert gebaut. Über dreissig Jahre Leidenschaft, vom ersten selbstgebauten Teich bis zum Wassergarten, der zum Herzstück Ihres Zuhauses wird.",
    "hero.cta1": "Referenzen ansehen", "hero.cta2": "Beratung anfragen",
    "hero.stat1": "Jahre Erfahrung", "hero.stat2": "gebaute Teiche", "hero.stat3": "massgeschneidert",
    "serv.kicker": "Was wir tun", "serv.title": "Wasserlösungen, massgeschneidert für Sie",
    ...
    "serv.koi.t": "Koiteiche", "serv.koi.d": "Lagunen für Kois mit professioneller Filterung und idealer Tiefe für gesunde, langlebige Tiere.",
    ...
    "about.p1": "Alles begann Anfang der 90er-Jahre mit dem ersten selbstgebauten Teich im eigenen Garten. Jahr für Jahr wurde aus der Leidenschaft für Wasser und Kois ein Beruf.",
    ...
    "proj.g1t": "Koi-Lagune", "proj.g1s": "Professionelle Filterung",
    ...
    "proj.note": "Beispielbilder. In der finalen Website werden sie durch echte Fotos Ihrer Arbeiten ersetzt.",
  ...
  fr: {
    ...
    "hero.eyebrow": "Tenero · Tessin · depuis 1990",
    "hero.title": "Nous utilisons l'eau pour donner vie à <span class=\"accent\">vos rêves</span>",
    "hero.lead": "Bassins à koïs, bio-étangs et piscines naturelles réalisés sur mesure. Plus de trente ans de passion, du premier bassin fait maison au jardin aquatique qui devient le cœur de votre maison.",
    "hero.cta1": "Voir les réalisations", "hero.cta2": "Demander une visite",
    "hero.stat1": "ans d'expérience", "hero.stat2": "bassins réalisés", "hero.stat3": "sur mesure",
    "serv.kicker": "Ce que nous faisons", "serv.title": "Des solutions d'eau, sur mesure pour vous",
    ...
    "serv.koi.t": "Bassins à koïs", "serv.koi.d": "Lagunes pour koïs avec filtration professionnelle et profondeur idéale pour des poissons sains et durables.",
    ...
    "about.p1": "Tout a commencé au début des années 90, avec le premier bassin fait maison réalisé dans le jardin. Année après année, la passion de l'eau et des koïs est devenue un métier.",
    ...
    "proj.g1t": "Lagune à koïs", "proj.g1s": "Filtration professionnelle",
    ...
    "proj.note": "Images de démonstration. Dans le site final, elles seront remplacées par les vraies photos de vos travaux.",
  ...
  en: {
    ...
    "hero.eyebrow": "Tenero · Ticino · since 1990",
    "hero.title": "We use water to bring <span class=\"accent\">your dreams</span> to life",
    "hero.lead": "Koi ponds, bio-ponds and natural swimming ponds built to measure. Over thirty years of passion, from the first DIY pond to a water garden that becomes the heart of your home.",
    "hero.cta1": "See our projects", "hero.cta2": "Request a site visit",
    "hero.stat1": "years of experience", "hero.stat2": "ponds built", "hero.stat3": "fully bespoke",
    "serv.kicker": "What we do", "serv.title": "Water solutions, tailored to you",
    "serv.sub": "From design to maintenance, we follow every stage with the care of people who turned a passion into a craft.",
    "serv.koi.t": "Koi ponds", "serv.koi.d": "Lagoons for koi with professional filtration and the ideal depth for healthy, long-lived fish.",
    ...
    "about.p1": "It all began in the early '90s, with the first DIY pond built in the home garden. Year after year, a passion for water and koi became a profession.",
    ...
    "proj.g1t": "Koi lagoon", "proj.g1s": "Professional filtration",
    ...
    "proj.note": "Demo images. On the final site these will be replaced with real photos of your work.",
